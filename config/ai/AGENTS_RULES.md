...
- Avoid abstractions. Write code in a **direct** and **explicit** manner. (eg: avoid `if true: 1; else: 0`, instead use `if true: 1; elseif false: 0; else: throw/unknown/unexpected`.)
